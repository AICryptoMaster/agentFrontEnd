...
export default function Page() {
  ...
  const twoHoursBlockNumber = 1800 * 2;
  const oneDayBlockNumber = 1800 * 24;
  ...
  return (
    <Box className={`${styles.page} flex-col align-center`}>
      <Box className={`${styles['section_1']} flex-row justify-between align-center`}>
        <Box className={`${styles['pair_info']} flex-col align-start`}>
          <Box className={`${styles['pair_name']}`}>   
        ...
        <Box className={`${styles['volumes']} flex-row justify-around align-center`}>
      ...
      <Box className={`${styles['section_1']} flex-row justify-around align-center`}>
        <Box id="TradeChart" style={{ width: "70%", height: "620px" }} />
      ...
      <Box className={`${styles['section_1']} flex-row justify-around align-center`} style={{marginTop: '20px'}}>
                ...
                curDisplayedTxs.length > 0 && 
                  curDisplayedTxs.map(transaction => (
                    <Tr>
                      ...
                      <Td>{formatAddress({address: transaction.trader, style: {fontSize: '12px'}})}</Td>
                    </Tr>
                  )) 
                }
                </Tbody>
